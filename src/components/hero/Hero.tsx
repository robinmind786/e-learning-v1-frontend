import { BadgeCheck, CircleCheck, Mail, Play } from "lucide-react";
...
import pattern1 from "../../assets/images/pattern/01.png";
  ...
  return (
    <>
      <section className="overflow-hidden">
        <div className="pt-6 pb-12 relative">
          <div className="w-full">
            <figure className="absolute hidden top-1/2 left-0 -translate-y-1/2 -ml-24 xl:block">
              <svg className=" fill-red-500 opacity-10 rotate-[74deg]">
            ...
            <span className="absolute top-1/2 right-0 -translate-y-1/2 -mr-12 hidden xl:inline-flex">
              <svg className="fill-yellow-500 -rotate-[186deg] opacity-80">
            ...
            <figure className="absolute top-0 left-0 ml-12">
              <svg
                className="fill-orange opacity-40"
                width="29px"
                height="29px"
              >
          ...
          <div className="container">
            <div className="grid grid-cols-2 gap-6 items-center max-md:grid-cols-1">
              <div className="relative">
                <figure className="fill-yellow-500 absolute bottom-0 right-0 mr-12 hidden xl:block">
                ...
                <figure className="fill-green-500 absolute top-0 left-1/2 -translate-y-1/2 ml-12 -mt-12">
                ...
                <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl mb-6">
                  ...
                  <span className="relative">
                    fingertips
                    <span className="absolute ml-4 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -z-10">
                      <svg
                        width="300px"
                        height="62.1px"
                ...
                <ul className="flex max-md:flex-wrap max-md:justify-center items-center mb-6">
                  ...
                  <Button className="" size="lg" variant="link">
                    <Link href="#" className="flex items-center gap-2 group">
                      <div className="flex items-center justify-center size-14 rounded-full">
                        <span className="inline-flex items-center justify-center size-12 rounded-full bg-blue-500/40 transition-all group-hover:size-full">
                          <span className="inline-flex items-center justify-center size-8 group-hover:size-10 transition-all rounded-full bg-blue-500">
              ...
              <div className="relative">
                <figure className="absolute bottom-0 left-1/2 -translate-x-1/2 mt-6 mb-0">
                  <svg
                    width="550px"
                    height="538px"
                    viewBox="0 0 554 544"
                ...
                <figure className="absolute bottom-0 left-1/2 -translate-x-1/2 -mb-12 z-10">
                ...
                <figure className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -mt-24">
                ...
                <div className="absolute top-1/2 left-0 -translate-y-1/2 -mt-24 p-2 bg-white rounded-lg shadow-lg hidden sm:block">
                  <Image src={science} alt="Icon" />
                </div>
                <div className="absolute top-0 mr-12 right-0 p-2 bg-white rounded-lg shadow-lg">
                  <Image src={angular} alt="Icon" />
                </div>
                <div className="absolute top-1/2 right-0 -translate-y-1/2 mt-12 ml-12 z-10 p-2 bg-white rounded-lg shadow-lg hidden md:block">
                  <Image src={figma} alt="Icon" />
                </div>
                <div className="absolute bottom-0 left-0 border boder-light mb-12 ml-12 p-4 z-10 backdrop-blur-lg rounded-lg hidden xl:block">
                  <div className="flex items-center">
                    <span className="size-14 text-center text-xl flex items-center justify-center bg-yellow-500 rounded-full">
                      <Mail />
                    </span>
                    <div className="text-left ml-4">
                      <small className="text-base font-medium leading-none flex items-center justify-between">
                        Congratulations
                        <span className="ml-6">
                ...
                <div className="absolute top-1/2 right-0 -translate-y-1/2 z-10 -mt-24 p-4 rounded-lg shadow-lg hidden md:block bg-cyan-500 bg-image">
                  <p className="mb-4 text-sm">Our daily new students</p>
