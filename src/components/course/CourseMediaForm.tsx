...
import { ArrowBigLeft, ArrowBigRight, ImageUp, X } from "lucide-react";
                        ...
                        {isDragActive ? (
                          ...
                          <div className="flex flex-col items-center justify-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                              Note: Only JPG, JPEG, and PNG formats are
                              supported. Our suggested dimensions are 600px *
                              450px. If you upload an image with different
                              dimensions, the system will automatically crop it
                              to fit our thumbnails/previews.
                            </p>
                          </div>
                        )}
                      </div>
